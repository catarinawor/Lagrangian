...
plot_logUtility <- function( M , Msq, sv=F, nome="",nations=F)
{
	...
	if(nations==F){
		...
		plut2  <- plut2  + geom_text(aes(x=intercept_hcr[utility_total2_comparison],y=slope_hcr[utility_total2_comparison],label="40:10"),fontface = "bold",colour="black")
		...
		plun1  <- plun1  + geom_text(aes(x=intercept_hcr[utility_nat1_comparison],y=slope_hcr[utility_nat1_comparison],label="40:10"),fontface = "bold",colour="black")	
		...
		plun2  <- plun2  + geom_text(aes(x=intercept_hcr[utility_nat2_comparison],y=slope_hcr[utility_nat2_comparison],label="40:10"),fontface = "bold",colour="black")
...
plot_logUtility_later <- function( M , Msq, sv=F, nome="",nations=F)
{
	cat("plot_logUtility")
	...
	for(i in 1:n){
		...
		slope_hcr[i]<-M[[i]][[1]]$slope_hcr
		intercept_hcr[i]<-M[[i]][[1]]$intercept_hcr
		utility_total[i]<-sum(log(apply(M[[i]][[1]]$yYieldNat[141:160,],1,sum)+0.01))
		utility_total2[i]<-sum(log(M[[i]][[1]]$yYieldNat[141:160,1]+1))*sum(log(M[[i]][[1]]$yYieldNat[141:160,2]+1))
		utility_nat1[i]<-sum(log(M[[i]][[1]]$yYieldNat[141:160,1]+0.01))
		utility_nat2[i]<-sum(log(M[[i]][[1]]$yYieldNat[141:160,2]+0.01))
	...
	for(y in 1:nsq){
		...
		slope_hcr_sq[y]<-999
		intercept_hcr_sq[y]<-999
		utility_total_sq[y]<-sum(log(apply(Msq[[y]][[1]]$yYieldNat[141:160,],1,sum)+0.01))
		utility_total2_sq[y]<-sum(log(Msq[[y]][[1]]$yYieldNat[141:160,1]+1))*sum(log(Msq[[y]][[1]]$yYieldNat[141:160,2]+1))
		utility_nat1_sq[y]<-sum(log(Msq[[y]][[1]]$yYieldNat[141:160,1]+0.01))
		utility_nat2_sq[y]<-sum(log(Msq[[y]][[1]]$yYieldNat[141:160,2]+0.01))
