...
readOutputsa <- function(dir)
{
	setwd(dir)
	sim <- read.rep("lagrangian_OM.rep")
	est <- read.rep("/Users/catarinawor/Documents/iSCAM/examples/hakelag/DATA/hakelag.rep")
	C <- list(sim=sim,est=est)
	return( C );
}
	...
	seed<-scan("seed.txt")	
	file.name <- paste("simSA",seed,".Rdata",sep="")
	sims<-readOutputsa("/Users/catarinawor/Documents/Lagrangian/")
	setwd("/Users/catarinawor/Documents/Lagrangian/SAsim1/")
