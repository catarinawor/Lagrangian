...
The historical population was reconstructed for the years 1966 to 2016 by simulating the population dynamics using the stock assessment parameters reported in \citet{berger_status_2017} and setting the historical catches equal to those extracted by the U.S.A. and Canada fleets during that period. Catches for both nations for the historical period were also reported by \citet{berger_status_2017}. Then the population was projected for 60 years into the future. For the projections, we assume that TAC allocation between nations remains constant as determined in the Pacific hake treaty, 73.88\% to the U.S.A. and 26.12\% to Canada.
...
\begin{figure}[ht]
\centering         
    \includegraphics[trim= 0mm 0mm 0mm 0mm, scale=.42]{Figurec4_3.pdf} 
...
\begin{figure}
\centering      
    \includegraphics[trim= 0mm 0mm 0mm 0mm, scale=.4]{Figurec4_4.pdf}  
